        ...
        >
          ...
          <div className="bg-primary/50 backdrop-blur-xl rounded-[1.3rem] p-10 md:p-16 h-full flex flex-col items-center justify-center border border-white/50 relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
              <button
                onClick={() =>
                  (window.location.href = "mailto:quorvia.labs@gmail.com")
                }
                className="flex items-center justify-center px-8 py-4 text-base font-bold rounded-xl text-white bg-slate-900 hover:bg-secondary transition-colors w-full sm:w-auto shadow-xl group"
              >
                <Mail className="w-5 h-5 mr-3 group-hover:scale-110 transition-transform" />
                quorvia.labs@gmail.com
              </button>
              <button
                onClick={() =>
                  window.open("https://wa.me/917558112196", "_blank")
                }
                className="flex items-center justify-center px-8 py-4 text-base font-bold rounded-xl text-white bg-[#25D366] border border-[#25D366] hover:border-secondary transition-colors w-full sm:w-auto group"
              >
                <svg
                  role="img"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
                  className="w-5 h-5 mr-3 fill-white group-hover:scale-110 transition-transform"
                >
